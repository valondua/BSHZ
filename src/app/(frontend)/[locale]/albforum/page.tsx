    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      {(() => {
        ...
        const placeholderIssues = [
          { id: 'p1', issueNumber: 1, title: 'ALBFORUM #1', description: { sq: 'Numri 1 i gazetës ALBFORUM', de: 'Ausgabe 1 der ALBFORUM Zeitung', fr: 'Numero 1 du journal ALBFORUM' }[locale] || 'ALBFORUM #1' },
          { id: 'p2', issueNumber: 2, title: 'ALBFORUM #2', description: { sq: 'Numri 2 i gazetës ALBFORUM', de: 'Ausgabe 2 der ALBFORUM Zeitung', fr: 'Numero 2 du journal ALBFORUM' }[locale] || 'ALBFORUM #2' },
          { id: 'p3', issueNumber: 3, title: 'ALBFORUM #3', description: { sq: 'Numri 3 i gazetës ALBFORUM', de: 'Ausgabe 3 der ALBFORUM Zeitung', fr: 'Numero 3 du journal ALBFORUM' }[locale] || 'ALBFORUM #3' },
          { id: 'p4', issueNumber: 4, title: 'ALBFORUM #4', description: { sq: 'Numri 4 i gazetës ALBFORUM', de: 'Ausgabe 4 der ALBFORUM Zeitung', fr: 'Numero 4 du journal ALBFORUM' }[locale] || 'ALBFORUM #4' },
          { id: 'p5', issueNumber: 5, title: 'ALBFORUM #5', description: { sq: 'Numri 5 i gazetës ALBFORUM', de: 'Ausgabe 5 der ALBFORUM Zeitung', fr: 'Numero 5 du journal ALBFORUM' }[locale] || 'ALBFORUM #5' },
          { id: 'p6', issueNumber: 6, title: 'ALBFORUM #6', description: { sq: 'Numri 6 i gazetës ALBFORUM', de: 'Ausgabe 6 der ALBFORUM Zeitung', fr: 'Numero 6 du journal ALBFORUM' }[locale] || 'ALBFORUM #6' },
        ]
                      ...
                      <div className="relative z-10 w-full pt-8 px-5">
                        <div className="border-b border-white/20 pb-3 mb-3">
                          <div className="text-white/50 text-[10px] tracking-[0.3em] uppercase text-center">
                            {{ sq: 'Gazeta e Bashkësisë Shqiptare në Zvicër', de: 'Zeitung der Albanischen Gemeinschaft in der Schweiz', fr: 'Journal de la Communaute albanaise en Suisse' }[locale]}
                          </div>
                        </div>
                      ...
                      <div className="relative z-10 flex-1 flex items-center justify-center">
                        ...
                        <div className="relative text-center">
                          <div className="text-white/60 text-xs tracking-[0.2em] uppercase mb-1">
                            {{ sq: 'Numri', de: 'Ausgabe', fr: 'Numero' }[locale]}
                          </div>
